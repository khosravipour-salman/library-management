...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'library_management_app.context_processors.log_user_activity',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'library_management_2',
        'USER': 'postgres',
        'PASSWORD': 'admin',
        'HOST': '127.0.0.1',
        # 'HOST': 'khosravi-library-management.herokuapp.com/',
        'PORT': '5432',
    }
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'django.librarymanagementsystem@gmail.com'
EMAIL_HOST_PASSWORD = '#@rDpA33'
